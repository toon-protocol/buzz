...
// Summary derivation (persona-drift classification, workspace-pair-key
// resolution, restart-eligibility) lives in runtime/summary.rs.
mod summary;
pub use summary::build_managed_agent_summary;
#[cfg(test)]
use summary::{persona_drift_state, restart_eligible};
pub(crate) use summary::{resolve_workspace_pair_key, workspace_pair_key};
