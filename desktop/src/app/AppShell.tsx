...
import { useAgentFleetPolicies } from "@/features/agents/lib/useAgentFleetPolicies";
...
export function AppShell() {
  ...
  // Agent fleet policy loops: Chunk F auto-restart + buzz#132 auto-refill.
  useAgentFleetPolicies();
