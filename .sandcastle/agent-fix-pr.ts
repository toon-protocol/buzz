...
// adapted to buzz's stage-0 sandbox conventions (pnpm install hooks —
// see ./agent-review-pr.ts, whose single-PR mechanics this mirrors: fetch the PR
...
const hooks = {
  sandbox: {
    onSandboxReady: [
      ...
      // buzz is a polyglot repo (Rust workspace + pnpm workspace, driven by
      // the Justfile); the JS side installs frozen here, mirroring
      // agent-review-pr.ts. Rust toolchains live in the agent image.
